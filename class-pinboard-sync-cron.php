...
use SyncPinboard\Sync_Pinboard_Core;
use SyncPinboard\Sync_Pinboard_Options;

class Sync_Pinboard_Cron {

	public $hook_name = 'sync_pinboard_cron_hook';

	public function __construct() {
		add_filter( 'cron_schedules', [ $this, 'sync_pinboard_cron_interval' ] );
		...
		add_action( 'sync_pinboard_deactivate', [ $this, 'remove_cron' ] );
 	}

	public function sync_pinboard_cron_interval( $schedules ) {
    ...
    public function sync() {
    	if (0 == Sync_Pinboard_Options::get_pin_sync_status()) {
    		return;
    	}
